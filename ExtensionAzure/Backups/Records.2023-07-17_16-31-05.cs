...
namespace OutSystems.NssExtensionAzure {
	...
	/// <summary>
	/// Structure <code>RCNewRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCNewRecord: ISerializable, ITypedRecord<RCNewRecord> {
		internal static readonly GlobalObjectKey IdNew = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*1I_USXQnIPTNF0__HeLfhg");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("New")]
		public ENNewEntityRecord ssENNew;


		public static implicit operator ENNewEntityRecord(RCNewRecord r) {
			return r.ssENNew;
		}

		public static implicit operator RCNewRecord(ENNewEntityRecord r) {
			RCNewRecord res = new RCNewRecord(null);
			res.ssENNew = r;
			return res;
		}
		...
		public BitArray ChangedAttributes {
			set {
				ssENNew.ChangedAttributes = value;
			}
			get {
				return ssENNew.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCNewRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENNew = new ENNewEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENNew.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENNew.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENNew.OptimizedAttributes;
				return all;
			}
		}
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCNewRecord r) {
			this = r;
		}


		public static bool operator == (RCNewRecord a, RCNewRecord b) {
			if (a.ssENNew != b.ssENNew) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCNewRecord)) return false;
			return (this == (RCNewRecord) o);
		}
		...
		public RCNewRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENNew = new ENNewEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENNew", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENNew' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENNew = (ENNewEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENNew.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENNew.InternalRecursiveSave();
		}


		public RCNewRecord Duplicate() {
			RCNewRecord t;
			t.ssENNew = (ENNewEntityRecord) this.ssENNew.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENNew.ToXml(this, recordElem, "New", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			variable.Found = false;
			if (head == "new") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".New")) variable.Value = ssENNew; else variable.Optimized = true;
				variable.SetFieldName("new");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENNew.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENNew.OptimizedAttributeGet(key);
		}
		...
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENNew.FillFromOther((IRecord) other.AttributeGet(IdNew));
		}
		public bool IsDefault() {
			RCNewRecord defaultStruct = new RCNewRecord(null);
			if (this.ssENNew != defaultStruct.ssENNew) return false;
			return true;
		}
	} // RCNewRecord
	...
	public partial struct RCJobTitleRecord: ISerializable, ITypedRecord<RCJobTitleRecord> {
		internal static readonly GlobalObjectKey IdJobTitle = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*ZVOZgQCy4nuRVKjBL+ntbQ");
	...
	public partial struct RCDepartmentRecord: ISerializable, ITypedRecord<RCDepartmentRecord> {
		internal static readonly GlobalObjectKey IdDepartment = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*ifi+rxkiUbkk2L1UrFz+VQ");
	...
	public partial struct RCBranchRecord: ISerializable, ITypedRecord<RCBranchRecord> {
		internal static readonly GlobalObjectKey IdBranch = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*DkhGpe7hIq+YwkRho9QZ8Q");
