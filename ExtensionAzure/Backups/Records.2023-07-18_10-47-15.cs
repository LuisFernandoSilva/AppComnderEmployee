...
namespace OutSystems.NssExtensionAzure {
	...
	public partial struct RCBranchRecord: ISerializable, ITypedRecord<RCBranchRecord> {
		internal static readonly GlobalObjectKey IdBranch = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*KG_RdBldtPzu6vCxVHExnw");
	...
	public partial struct RCPayrollPDFRecord: ISerializable, ITypedRecord<RCPayrollPDFRecord> {
		internal static readonly GlobalObjectKey IdPayrollPDF = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*9cHd0TsPeFcB5d4TZ9RVYw");
	...
	public partial struct RCTimeSheetPDFRecord: ISerializable, ITypedRecord<RCTimeSheetPDFRecord> {
		internal static readonly GlobalObjectKey IdTimeSheetPDF = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*tKgCEr03UhNj_QFJPi+Uqg");
	...
	public partial struct RCDepartmentRecord: ISerializable, ITypedRecord<RCDepartmentRecord> {
		internal static readonly GlobalObjectKey IdDepartment = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*Kq+GNRotKpEeCXCvLDdK0g");
	...
	public partial struct RCJobTitleRecord: ISerializable, ITypedRecord<RCJobTitleRecord> {
		internal static readonly GlobalObjectKey IdJobTitle = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*mgASqULxJGrDYdvBepUPmw");
	...
	/// <summary>
	/// Structure <code>RCTesteDOTesteRecord</code>
	/// </summary>
	[Serializable()]
	public partial struct RCTesteDOTesteRecord: ISerializable, ITypedRecord<RCTesteDOTesteRecord> {
		internal static readonly GlobalObjectKey IdTesteDOTeste = GlobalObjectKey.Parse("2UmDmepsh0WSfJ_D1JexCA*LNQjacUF2NUqp76I+Acorg");

		public static void EnsureInitialized() {}
		[System.Xml.Serialization.XmlElement("TesteDOTeste")]
		public ENTesteDOTesteEntityRecord ssENTesteDOTeste;


		public static implicit operator ENTesteDOTesteEntityRecord(RCTesteDOTesteRecord r) {
			return r.ssENTesteDOTeste;
		}

		public static implicit operator RCTesteDOTesteRecord(ENTesteDOTesteEntityRecord r) {
			RCTesteDOTesteRecord res = new RCTesteDOTesteRecord(null);
			res.ssENTesteDOTeste = r;
			return res;
		}

		public BitArray ChangedAttributes {
			set {
				ssENTesteDOTeste.ChangedAttributes = value;
			}
			get {
				return ssENTesteDOTeste.ChangedAttributes;
			}
		}
		public BitArray OptimizedAttributes;

		public RCTesteDOTesteRecord(params string[] dummy) {
			OptimizedAttributes = null;
			ssENTesteDOTeste = new ENTesteDOTesteEntityRecord(null);
		}
		...
		public BitArray[] AllOptimizedAttributes {
			set {
				if (value == null) {
					ssENTesteDOTeste.OptimizedAttributes = GetDefaultOptimizedValues()[0];
				} else {
					ssENTesteDOTeste.OptimizedAttributes = value[0];
				}
			}
			get {
				BitArray[] all = new BitArray[1];
				all[0] = ssENTesteDOTeste.OptimizedAttributes;
				return all;
			}
		}
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssENTesteDOTeste.Read(r, ref index);
		}
		/// <summary>
		/// Read from database
		/// </summary>
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(RCTesteDOTesteRecord r) {
			this = r;
		}


		public static bool operator == (RCTesteDOTesteRecord a, RCTesteDOTesteRecord b) {
			if (a.ssENTesteDOTeste != b.ssENTesteDOTeste) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(RCTesteDOTesteRecord)) return false;
			return (this == (RCTesteDOTesteRecord) o);
		}

		public override int GetHashCode() {
			try {
				return base.GetHashCode()
				^ ssENTesteDOTeste.GetHashCode()
				;
			} catch {
				return base.GetHashCode();
			}
		...
		public RCTesteDOTesteRecord(SerializationInfo info, StreamingContext context) {
			OptimizedAttributes = null;
			ssENTesteDOTeste = new ENTesteDOTesteEntityRecord(null);
			Type objInfo = this.GetType();
			FieldInfo fieldInfo = null;
			fieldInfo = objInfo.GetField("ssENTesteDOTeste", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named 'ssENTesteDOTeste' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				ssENTesteDOTeste = (ENTesteDOTesteEntityRecord) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}

		public void RecursiveReset() {
			ssENTesteDOTeste.RecursiveReset();
		}

		public void InternalRecursiveSave() {
			ssENTesteDOTeste.InternalRecursiveSave();
		}


		public RCTesteDOTesteRecord Duplicate() {
			RCTesteDOTesteRecord t;
			t.ssENTesteDOTeste = (ENTesteDOTesteEntityRecord) this.ssENTesteDOTeste.Duplicate();
			t.OptimizedAttributes = null;
			return t;
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				ssENTesteDOTeste.ToXml(this, recordElem, "TesteDOTeste", detailLevel - 1);
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			String tail = VarValue.GetTail(fields);
			variable.Found = false;
			if (head == "testedoteste") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".TesteDOTeste")) variable.Value = ssENTesteDOTeste; else variable.Optimized = true;
				variable.SetFieldName("testedoteste");
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}

		public bool ChangedAttributeGet(GlobalObjectKey key) {
			return ssENTesteDOTeste.ChangedAttributeGet(key);
		}

		public bool OptimizedAttributeGet(GlobalObjectKey key) {
			return ssENTesteDOTeste.OptimizedAttributeGet(key);
		}

		public object AttributeGet(GlobalObjectKey key) {
			if (key == IdTesteDOTeste) {
				return ssENTesteDOTeste;
			} else {
				throw new Exception("Invalid key");
			}
		}
		public void FillFromOther(IRecord other) {
			if (other == null) return;
			ssENTesteDOTeste.FillFromOther((IRecord) other.AttributeGet(IdTesteDOTeste));
		}
		public bool IsDefault() {
			RCTesteDOTesteRecord defaultStruct = new RCTesteDOTesteRecord(null);
			if (this.ssENTesteDOTeste != defaultStruct.ssENTesteDOTeste) return false;
			return true;
		}
	} // RCTesteDOTesteRecord
}
