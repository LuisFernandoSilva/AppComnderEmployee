...
namespace OutSystems.NssExtensionAzure {
	...
	/// <summary>
	/// RecordList type <code>RLTesteDOTesteRecordList</code> that represents a record list of
	///  <code>TesteDOTeste</code>
	/// </summary>
	[Serializable()]
	public partial class RLTesteDOTesteRecordList: GenericRecordList<RCTesteDOTesteRecord>, IEnumerable, IEnumerator, ISerializable {
		public static void EnsureInitialized() {}

		protected override RCTesteDOTesteRecord GetElementDefaultValue() {
			return new RCTesteDOTesteRecord("");
		}

		public T[] ToArray<T>(Func<RCTesteDOTesteRecord, T> converter) {
			return ToArray(this, converter);
		}

		public static T[] ToArray<T>(RLTesteDOTesteRecordList recordlist, Func<RCTesteDOTesteRecord, T> converter) {
			return InnerToArray(recordlist, converter);
		}
		public static implicit operator RLTesteDOTesteRecordList(RCTesteDOTesteRecord[] array) {
			RLTesteDOTesteRecordList result = new RLTesteDOTesteRecordList();
			result.InnerFromArray(array);
			return result;
		}

		public static RLTesteDOTesteRecordList ToList<T>(T[] array, Func <T, RCTesteDOTesteRecord> converter) {
			RLTesteDOTesteRecordList result = new RLTesteDOTesteRecordList();
			result.InnerFromArray(array, converter);
			return result;
		}

		public static RLTesteDOTesteRecordList FromRestList<T>(RestList<T> restList, Func <T, RCTesteDOTesteRecord> converter) {
			RLTesteDOTesteRecordList result = new RLTesteDOTesteRecordList();
			result.InnerFromRestList(restList, converter);
			return result;
		}
		...
		/// Default Constructor
		/// </summary>
		public RLTesteDOTesteRecordList(): base() {
		}
		...
		/// <param name="trans"> IDbTransaction Parameter</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLTesteDOTesteRecordList(IDbTransaction trans): base(trans) {
		}
		...
		/// <param name="alternateReadDBMethod"> Alternate Read Method</param>
		[Obsolete("Use the Default Constructor and set the Transaction afterwards.")]
		public RLTesteDOTesteRecordList(IDbTransaction trans, ReadDBMethodDelegate alternateReadDBMethod): this(trans) {
			this.alternateReadDBMethod = alternateReadDBMethod;
		}
		...
		/// <param name="info"> SerializationInfo</param>
		/// <param name="context"> StreamingContext</param>
		public RLTesteDOTesteRecordList(SerializationInfo info, StreamingContext context): base(info, context) {
		}
		...
		/// </summary>
		/// <returns>The new record list</returns>
		protected override OSList<RCTesteDOTesteRecord> NewList() {
			return new RLTesteDOTesteRecordList();
		}


	} // RLTesteDOTesteRecordList
}
