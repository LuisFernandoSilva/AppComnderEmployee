...
namespace OutSystems.NssExtensionAzure {
	...
	public partial struct ENEmployeeEntityRecord: ISerializable, ITypedRecord<ENEmployeeEntityRecord>, ISimpleRecord {
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("JobTitle", 0, false, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("Department", 0, false, false, false, false)]
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("Branch", 0, false, false, false, false)]
		...
		public void Read(IDataReader r, ref int index) {
			...
			ssJobTitle = r.ReadLongInteger(index++, "Employee.JobTitle", 0L);
			ssDepartment = r.ReadLongInteger(index++, "Employee.Department", 0L);
			ssBranch = r.ReadLongInteger(index++, "Employee.Branch", 0L);
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				...
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".JobTitle")) VarValue.AppendAttribute(recordElem, "JobTitle", ssJobTitle, detailLevel, TypeKind.LongInteger); else VarValue.AppendOptimizedAttribute(recordElem, "JobTitle");
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".Department")) VarValue.AppendAttribute(recordElem, "Department", ssDepartment, detailLevel, TypeKind.LongInteger); else VarValue.AppendOptimizedAttribute(recordElem, "Department");
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".Branch")) VarValue.AppendAttribute(recordElem, "Branch", ssBranch, detailLevel, TypeKind.LongInteger); else VarValue.AppendOptimizedAttribute(recordElem, "Branch");
