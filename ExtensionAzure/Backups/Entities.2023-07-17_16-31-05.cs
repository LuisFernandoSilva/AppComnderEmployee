...
namespace OutSystems.NssExtensionAzure {
	...
	public class ENNewEntityConfiguration {
		private static object config;
		private static string PhysicalTableName {
			get {
				try {
					...
					if (EntityConfiguration != null) {
						if (config == null) {
							config = EntityConfiguration.GetMethod("GetEntityConfiguration", BindingFlags.Public | BindingFlags.Static).Invoke(null, new object[] { "ef158d7b-f666-4ddd-8da2-8958459111da", "262bc89e-d067-4ade-89fd-432318a003fe", "New", "[Outsystems].[dbo].[New]"}); 
						}
						return EntityConfiguration.GetProperty("PhysicalTableName").GetValue(config).ToString();
					} else {
	...
	public sealed partial class ENNewEntity {
		private static readonly System.Collections.Generic.Dictionary<string, string> entityAttributes = new System.Collections.Generic.Dictionary<string, string>() {
			{ "id", "id"
			}
			, { "title", "Title"
		...
		public static string ViewName(int? tenant, string locale) {
			return ENNewEntityConfiguration.GetPhysicalTableName();
		}
	} // ENNewEntity

	/// <summary>
	/// Entity <code>ENNewEntityRecord</code> that represents the Service Studio entity <code>New</code>
	...
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("New", "nsgrJmfQ3kqJ_UMjGKAD_g", "e40V72b23U2NoolYRZER2g", 0, "[Outsystems].[dbo].[New]", null)]
	[Serializable()]
	public partial struct ENNewEntityRecord: ISerializable, ITypedRecord<ENNewEntityRecord>, ISimpleRecord {
		...
		public ENNewEntityRecord(params string[] dummy) {
			ChangedAttributes = new BitArray(10, true);
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssid = r.ReadInteger(index++, "New.id", 0);
			ssTitle = r.ReadText(index++, "New.Title", "");
			ssContent = r.ReadText(index++, "New.Content", "");
			ssURLPhotoNews = r.ReadText(index++, "New.URLPhotoNews", "");
			ssURLNews = r.ReadText(index++, "New.URLNews", "");
			ssIsActive = r.ReadBoolean(index++, "New.IsActive", false);
			ssUpdateOn = r.ReadDateTime(index++, "New.UpdateOn", new DateTime(1900, 1, 1, 0, 0, 0));
			ssCreatedOn = r.ReadDateTime(index++, "New.CreatedOn", new DateTime(1900, 1, 1, 0, 0, 0));
			ssCreatedBy = r.ReadLongInteger(index++, "New.CreatedBy", 0L);
			ssUpdateBy = r.ReadLongInteger(index++, "New.UpdateBy", 0L);
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(ENNewEntityRecord r) {
			this = r;
		}


		public static bool operator == (ENNewEntityRecord a, ENNewEntityRecord b) {
			if (a.ssid != b.ssid) return false;
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(ENNewEntityRecord)) return false;
			return (this == (ENNewEntityRecord) o);
		}
		...
		public ENNewEntityRecord(SerializationInfo info, StreamingContext context) {
			ChangedAttributes = new BitArray(10, true);
			OptimizedAttributes = new BitArray(10, false);
			_ssid = 0;
			_ssTitle = "";
		...
		public ENNewEntityRecord Duplicate() {
			ENNewEntityRecord t;
			t._ssid = this._ssid;
		...
		public bool IsDefault() {
			ENNewEntityRecord defaultStruct = new ENNewEntityRecord(null);
			if (this.ssid != defaultStruct.ssid) return false;
		...
		private static string PhysicalTableName {
			get {
				try {
					...
					if (EntityConfiguration != null) {
						if (config == null) {
							config = EntityConfiguration.GetMethod("GetEntityConfiguration", BindingFlags.Public | BindingFlags.Static).Invoke(null, new object[] { "ef158d7b-f666-4ddd-8da2-8958459111da", "83aad0d9-41e8-4d10-ba4b-9e633124e4f9", "JobTitle", "[Outsystems].[dbo].[JobTitle]"}); 
						}
						return EntityConfiguration.GetProperty("PhysicalTableName").GetValue(config).ToString();
					} else {
	...
	///  <code>JobTitle</code> <p> Description: Static entity that defines the name of the job title on d
	/// e company</p>
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("JobTitle", "2dCqg+hBEE26S55jMSTk+Q", "e40V72b23U2NoolYRZER2g", 0, "[Outsystems].[dbo].[JobTitle]", null)]
	[Serializable()]
	public partial struct ENJobTitleEntityRecord: ISerializable, ITypedRecord<ENJobTitleEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey Idid = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*OWPIW35igkGFHJvvB2V8Qg");
		internal static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*LfarOdK2rkqgqp_zigg1aA");
		internal static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*S4U5L7Ac7EGijfnepwWEzw");
		internal static readonly GlobalObjectKey IdIs_Active = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*SMHP8Qnjo023qL9yGaG11g");
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("Order", 50, false, false, false, false)]
		[System.Xml.Serialization.XmlElement("Order")]
		private string _ssOrder;
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("Is_Active", 50, false, false, false, true)]
		[System.Xml.Serialization.XmlElement("Is_Active")]
		private string _ssIs_Active;
		public string ssIs_Active {
			get {
				return _ssIs_Active;
			}
			set {
		...
		public void Read(IDataReader r, ref int index) {
			...
			ssOrder = r.ReadText(index++, "JobTitle.Order", "");
			ssIs_Active = r.ReadText(index++, "JobTitle.Is_Active", "");
		...
		public ENJobTitleEntityRecord(SerializationInfo info, StreamingContext context) {
			...
			if (fieldInfo.FieldType.IsSerializable) {
				_ssOrder = (string) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
			...
			if (fieldInfo.FieldType.IsSerializable) {
				_ssIs_Active = (string) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				...
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".Order")) VarValue.AppendAttribute(recordElem, "Order", ssOrder, detailLevel, TypeKind.Text); else VarValue.AppendOptimizedAttribute(recordElem, "Order");
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".Is_Active")) VarValue.AppendAttribute(recordElem, "Is_Active", ssIs_Active, detailLevel, TypeKind.Text); else VarValue.AppendOptimizedAttribute(recordElem, "Is_Active");
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void FillFromOther(IRecord other) {
			...
			ssIs_Active = (string) other.AttributeGet(IdIs_Active);
		...
		private static string PhysicalTableName {
			get {
				try {
					...
					if (EntityConfiguration != null) {
						if (config == null) {
							config = EntityConfiguration.GetMethod("GetEntityConfiguration", BindingFlags.Public | BindingFlags.Static).Invoke(null, new object[] { "ef158d7b-f666-4ddd-8da2-8958459111da", "01f323e2-61f1-49bc-8da7-69a29bc1a6d4", "Department", "[Outsystems].[dbo].[Department]"}); 
						}
						return EntityConfiguration.GetProperty("PhysicalTableName").GetValue(config).ToString();
					} else {
	...
	///  <code>Department</code> <p> Description: Static entity that defines the name of the company'
	/// s departments</p>
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("Department", "4iPzAfFhvEmNp2mim8Gm1A", "e40V72b23U2NoolYRZER2g", 0, "[Outsystems].[dbo].[Department]", null)]
	[Serializable()]
	public partial struct ENDepartmentEntityRecord: ISerializable, ITypedRecord<ENDepartmentEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey Idid = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*4uy7UI4g+0OMwVmqk5G1fg");
		internal static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*l_r3FFtQNk+KLaX18DXVdg");
		internal static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*4Bikr0Qu+kioGeL6RRRxrQ");
		internal static readonly GlobalObjectKey IdIs_Active = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*LM73s8XJBU2ebr69sowSmw");
		...
		private static string PhysicalTableName {
			get {
				try {
					...
					if (EntityConfiguration != null) {
						if (config == null) {
							config = EntityConfiguration.GetMethod("GetEntityConfiguration", BindingFlags.Public | BindingFlags.Static).Invoke(null, new object[] { "ef158d7b-f666-4ddd-8da2-8958459111da", "73c7b3b9-7109-4472-b4a2-ae583077edc3", "Branch", "[Outsystems].[dbo].[Branch]"}); 
						}
						return EntityConfiguration.GetProperty("PhysicalTableName").GetValue(config).ToString();
					} else {
	...
	///  <code>Branch</code> <p> Description: Static entity that defines the name of the company'
	/// s branches</p>
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("Branch", "ubPHcwlxckS0oq5YMHftww", "e40V72b23U2NoolYRZER2g", 0, "[Outsystems].[dbo].[Branch]", null)]
	[Serializable()]
	public partial struct ENBranchEntityRecord: ISerializable, ITypedRecord<ENBranchEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey Idid = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*KbXeYkbXQ0aOqrETQC6hUA");
		internal static readonly GlobalObjectKey IdLabel = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*fvOqWvCveE2gwbYQxJGKUg");
		internal static readonly GlobalObjectKey IdOrder = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*LRDfQXs68UmpNf2hcLoSpA");
		internal static readonly GlobalObjectKey IdIs_Active = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*zXNiljvlz0ilxtWzVuEMZg");
