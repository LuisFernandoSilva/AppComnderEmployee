...
namespace OutSystems.NssExtensionAzure {
	...
	public class ENTesteDOTesteEntityConfiguration {
		private static object config;
		private static string PhysicalTableName {
			get {
				try {
					...
					if (EntityConfiguration != null) {
						if (config == null) {
							config = EntityConfiguration.GetMethod("GetEntityConfiguration", BindingFlags.Public | BindingFlags.Static).Invoke(null, new object[] { "ef158d7b-f666-4ddd-8da2-8958459111da", "9e9325af-843b-4077-9f55-453810c26752", "TesteDOTeste", "[Outsystems].[dbo].[TesteDOTeste]"}); 
						}
						return EntityConfiguration.GetProperty("PhysicalTableName").GetValue(config).ToString();
					} else {
						return "[Outsystems].[dbo].[TesteDOTeste]"; 
					}
				} catch {
					return "[Outsystems].[dbo].[TesteDOTeste]"; 
				}
	...
	public sealed partial class ENTesteDOTesteEntity {
		private static readonly System.Collections.Generic.Dictionary<string, string> entityAttributes = new System.Collections.Generic.Dictionary<string, string>() {
			{ "id", "id"
			}
		...
		public static string ViewName(int? tenant, string locale) {
			return ENTesteDOTesteEntityConfiguration.GetPhysicalTableName();
		}
	} // ENTesteDOTesteEntity

	/// <summary>
	/// Entity <code>ENTesteDOTesteEntityRecord</code> that represents the Service Studio entity
	///  <code>TesteDOTeste</code> <p> Description: </p>
	/// </summary>
	[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityRecordDetails("TesteDOTeste", "ryWTnjuEd0CfVUU4EMJnUg", "e40V72b23U2NoolYRZER2g", 0, "[Outsystems].[dbo].[TesteDOTeste]", null)]
	[Serializable()]
	public partial struct ENTesteDOTesteEntityRecord: ISerializable, ITypedRecord<ENTesteDOTesteEntityRecord>, ISimpleRecord {
		internal static readonly GlobalObjectKey Idid = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*qTGJdS9mxkS8lWZIqIf1VA");
		internal static readonly GlobalObjectKey IdtextoTEste = GlobalObjectKey.Parse("e40V72b23U2NoolYRZER2g*dz+3JD26hUGa8azXM7GYhg");
		...
		[OutSystems.HubEdition.RuntimePlatform.MetaInformation.EntityAttributeDetails("textoTEste", 50, false, false, false, true)]
		[System.Xml.Serialization.XmlElement("textoTEste")]
		private string _sstextoTEste;
		public string sstextoTEste {
			get {
				return _sstextoTEste;
			}
			set {
				if ((_sstextoTEste!=value) || OptimizedAttributes[1]) {
					ChangedAttributes[1] = true;
					_sstextoTEste = value;
				}
			}
		...
		public ENTesteDOTesteEntityRecord(params string[] dummy) {
			ChangedAttributes = new BitArray(2, true);
		...
		/// <param name="index"> index</param>
		public void Read(IDataReader r, ref int index) {
			ssid = r.ReadInteger(index++, "TesteDOTeste.id", 0);
			sstextoTEste = r.ReadText(index++, "TesteDOTeste.textoTEste", "");
		...
		/// </summary>
		/// <param name="r"> Record</param>
		public void ReadIM(ENTesteDOTesteEntityRecord r) {
			this = r;
		}


		public static bool operator == (ENTesteDOTesteEntityRecord a, ENTesteDOTesteEntityRecord b) {
			if (a.ssid != b.ssid) return false;
			if (a.sstextoTEste != b.sstextoTEste) return false;
			return true;
		}
		...
		public override bool Equals(object o) {
			if (o.GetType() != typeof(ENTesteDOTesteEntityRecord)) return false;
			return (this == (ENTesteDOTesteEntityRecord) o);
		}
		...
		public ENTesteDOTesteEntityRecord(SerializationInfo info, StreamingContext context) {
			ChangedAttributes = new BitArray(2, true);
			OptimizedAttributes = new BitArray(2, false);
			_ssid = 0;
			_sstextoTEste = "";
			...
			fieldInfo = objInfo.GetField("_sstextoTEste", BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public);
			if (fieldInfo == null) {
				throw new Exception("The field named '_sstextoTEste' was not found.");
			}
			if (fieldInfo.FieldType.IsSerializable) {
				_sstextoTEste = (string) info.GetValue(fieldInfo.Name, fieldInfo.FieldType);
			}
		}
		...
		public ENTesteDOTesteEntityRecord Duplicate() {
			ENTesteDOTesteEntityRecord t;
			t._ssid = this._ssid;
			t._sstextoTEste = this._sstextoTEste;
		...
		public void ToXml(Object parent, System.Xml.XmlElement baseElem, String fieldName, int detailLevel) {
			...
			if (detailLevel > 0) {
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".id")) VarValue.AppendAttribute(recordElem, "id", ssid, detailLevel, TypeKind.Integer); else VarValue.AppendOptimizedAttribute(recordElem, "id");
				if (!VarValue.FieldIsOptimized(parent, fieldName + ".textoTEste")) VarValue.AppendAttribute(recordElem, "textoTEste", sstextoTEste, detailLevel, TypeKind.Text); else VarValue.AppendOptimizedAttribute(recordElem, "textoTEste");
			} else {
				VarValue.AppendDeferredEvaluationElement(recordElem);
			}
		}
		...
		public void EvaluateFields(VarValue variable, Object parent, String baseName, String fields) {
			...
			if (head == "id") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".id")) variable.Value = ssid; else variable.Optimized = true;
			} else if (head == "textoteste") {
				if (!VarValue.FieldIsOptimized(parent, baseName + ".textoTEste")) variable.Value = sstextoTEste; else variable.Optimized = true;
			}
			if (variable.Found && tail != null) variable.EvaluateFields(this, head, tail);
		}
		...
		public bool ChangedAttributeGet(GlobalObjectKey key) {
			if (key.Equals(Idid)) {
				return ChangedAttributes[0];
			} else if (key.Equals(IdtextoTEste)) {
				return ChangedAttributes[1];
			} else {
				throw new Exception("Invalid key");
			}
		...
		public void FillFromOther(IRecord other) {
			...
			ChangedAttributes[0] = other.ChangedAttributeGet(Idid);
			OptimizedAttributes[0] = other.OptimizedAttributeGet(Idid);
			sstextoTEste = (string) other.AttributeGet(IdtextoTEste);
			ChangedAttributes[1] = other.ChangedAttributeGet(IdtextoTEste);
			OptimizedAttributes[1] = other.OptimizedAttributeGet(IdtextoTEste);
		}
		public bool IsDefault() {
			ENTesteDOTesteEntityRecord defaultStruct = new ENTesteDOTesteEntityRecord(null);
			if (this.ssid != defaultStruct.ssid) return false;
			if (this.sstextoTEste != defaultStruct.sstextoTEste) return false;
			return true;
		}
	} // ENTesteDOTesteEntityRecord
